    ...
    return (
        <>
            <div className="text-center">
                <h1 className="text-8xl font-medium tracking-widest mb-8">about</h1>
                <p>Halo Daimus Disini</p>
                <ul className="list-none flex gap-2 justify-center mt-4">
                    <li className="inline">
                        <a href="https://daimus.id" target="_blank" rel="noopener noreferrer">
                    ...
                    <li className="inline">
                        <a href="https://linkedin.com/in/daimus" target="_blank" rel="noopener noreferrer">
                    ...
                    <li className="inline">
                        <a href="https://github.com/daimus" target="_blank" rel="noopener noreferrer">
